...
class obuInterfaceServer: public ServerTemplate<obuInterfaceConnection>{
public:
...
int main(int argc, char **argv){
	ros::init(argc, argv, "obuInterfaceBoost");

    //handle option
	string serverIP = "127.0.0.1";
	string serverPort = "5100";
	int option;
	int threadNum = 5;
	...
	try{
		...
		obuInterfaceServer server(serverIP, serverPort, threadNum);
